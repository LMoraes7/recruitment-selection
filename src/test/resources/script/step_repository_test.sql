...
insert into selection_processes_steps(id_selective_process, id_step, id_next_step, limit_time) values ('SEL-123456781', 'STE-123456789', 'STE-987654321', null);
insert into selection_processes_steps(id_selective_process, id_step, id_next_step, limit_time) values ('SEL-123456781', 'STE-987654321', null, 4);
...
insert into applications_steps (id_application, id_step, id_next_step, status, limit_time, release_date) values ('APP-123456781', 'STE-123456789', 'STE-987654321', 'BLOCKED', null, null);
insert into applications_steps (id_application, id_step, id_next_step, status, limit_time, release_date) values ('APP-123456781', 'STE-987654321', null, 'BLOCKED', 5, '2023-09-18');